...
la version publicada es `0.1.0-beta.4`, que reemplaza al intento `beta.3`
...
- Version beta publicada: `0.1.0-beta.4`, commit
...
La beta `0.1.0-beta.4` esta desplegada en el proyecto Vercel existente
`poseidon-sistema-gestio`. La rama de produccion de ese proyecto es
`release/test`, y `vercel.json` impide que `main` genere despliegues
automaticos.
