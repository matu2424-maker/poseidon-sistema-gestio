...
Custodia panel del encargado, diferencias, control de gastos y vistas propias de supervision. El encargado consulta cuentas, salarios, cierres y auditoria, pero opera caja solo cambiando a funcion Cajero. Las formulas, comandos financieros, salarios y maestros pertenecen a contratos compartidos o especialistas: solicita cualquier cambio al chat central.
