...
Custodia panel del encargado, diferencias, control de gastos y vistas propias de supervision. El encargado consulta cuentas, salarios, cierres y auditoria; desde su funcion puede registrar gastos y retiros/aportes sobre la caja abierta asignada. Para el resto del flujo cambia a Cajero. Las formulas, comandos financieros, salarios y maestros pertenecen a contratos compartidos o especialistas: solicita cualquier cambio al chat central.
