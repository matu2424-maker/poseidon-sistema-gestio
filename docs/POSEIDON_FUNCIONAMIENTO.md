...
- Apertura, contadores, cierre, diferencias, movimientos operativos y operaciones salariales criticas usan comandos en `src/application/` con actor, funcion, reloj e IDs inyectables.
