...
| 2026-07-26-CAL-01 | Poseidon Calidad y Pruebas | E2E de Locales, Maquinas, Personal, Clientes y Papelera | `codex/calidad-pruebas` / `294d2e4`, integrado en `main` / `4b809ce` | Solo pruebas descartables; Central corrigio referencias historicas en validacion | `INTEGRADA` | 10/10 E2E dirigidos; resolucion en `docs/calidad/2026-07-26-central-resolucion-cal-01.md` |
