...
4. Abrir `http://127.0.0.1:5173/` en el navegador integrado y comprobar titulo, DOM principal y ausencia de pantalla de error.
5. Si el usuario necesita su sesion real de Chrome, usar el control de Chrome despues de comprobar primero el navegador integrado.
